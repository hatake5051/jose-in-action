...
//  *    parameters              ANY DEFINED BY algorithm OPTIONAL  }
//  */
// type X509SPKI<K extends 'RSA' | 'EC' = 'RSA' | 'EC'> = {
//   kty: K;
//   raw: Uint8Array;
// } & (K extends 'RSA'
//   ? {
...
//       return 'Private';
//     default:
//       throw new TypeError('クラスは 00 ~ 11 の範囲のみ');
//   }
// }
...
//       return 'Constructed';
//     default:
//       throw new TypeError('P/C は 0 か 1 のいずれか');
//   }
// }
...
//   typeFieldLen: number;
// } {
//   if (typeField.length < 1) throw new TypeError('Type Filed が与えられていない');
